...
export function KnowledgeGraph() {
  ...
  async function deleteMemory(id:number){const d=await api.delete<any>(`/knowledge/memory/${id}`);if(d.error)return toastErr(d.error);setMemories(memories.filter(m=>m.id!==id));toast("Removed from Knowledge Vault.","ok");}
